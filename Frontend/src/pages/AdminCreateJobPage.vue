...
onMounted(async () => {
  ...
  try {
    ...
    form.jobType = (existing.inspectionType === 'CONSTRUCTION_INSPECTION' || existing.inspectionType === 'Construction' || existing.inspectionType === 'ตรวจก่อสร้าง') ? 'construction' : 'defect';
  ...
  try {
    ...
    if (isEditMode.value && editId.value) {
      ...
      if (existingJob) {
        ...
        const inspectionTypeStr = form.jobType === 'construction' ? 'CONSTRUCTION_INSPECTION' : 'DEFECT_INSPECTION';
